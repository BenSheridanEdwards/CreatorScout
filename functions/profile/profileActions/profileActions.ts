...
export async function sendDMToUser(
	...
	try {
		...
		// Look for message input - try multiple selectors, starting with the exact
		// structure seen in the current DM UI:
		// <div role="textbox" aria-label="Message" contenteditable data-lexical-editor="true">
